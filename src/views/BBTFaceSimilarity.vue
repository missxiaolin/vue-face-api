<template>
    <div class="face_similarity">
        <div class="option">
            <div class="org">
                <label>更换图片org</label>
                <input type="file" accept="image/png, image/jpeg" @change="fnChange($event, 'org')" />
            </div>
            <div class="det">
                <label>更换图片det</label>
                <input type="file" accept="image/png, image/jpeg" @change="fnChange($event, 'det')" />
            </div>
            <div>
...
.option div {
    padding: 10px;
    border-bottom: 2px #5a14a4 solid;
}
